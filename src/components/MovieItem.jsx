        ...
        >
          {isFavorite ? (
            ...
            <svg 
              ...
              fill="none" 
              xmlns="http://www.w3.org/2000/svg"
              className="transition-colors duration-300 group-hover:[&>g>path]:fill-[#724CF9]"
            >
                <path 
                  ...
                  fill="white"
                  className="transition-colors duration-300 group-hover:fill-[#724CF9]"
                />
           </svg>
          )}
        </button>
