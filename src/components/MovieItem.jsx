  ...
  return (
    <li className="flex items-start bg-[#070D23] mt-4 pb-4 border-b border-b-[1px] border-[rgba(34,44,79,0.5)]  last:border-b-0">
      ...
      <div className="ml-4 flex-1 flex flex-col ">
          ...
          >
            <svg
              ...
              className={`transition-colors duration-300 ${
               ...
               : "fill-none stroke-white hover:stroke-purple-500 hover:fill-purple-500"
              }`}
            >
        ...
        >
          {movie.year} • {movie.country} • <img src={StarIcon} alt="star" className="w-4 h-4" />{movie.imdb_rating} 
        </p>
      </div>
    </li>
  );
